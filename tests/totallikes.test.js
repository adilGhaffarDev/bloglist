...
describe('author with most blogs', () => {
  ...
  test('author that has most blogs', () => {
    var mostBloggedAuthor = function(res) {
      return res.author === 'Robert C. Martin' && res.blogs === 3
    }
    const result = listHelper.mostBlogs(listWithSixBlog)
    expect(mostBloggedAuthor(result))
  })
...
describe('author with most like', () => {
  ...
  test('author that has most likes', () => {
    var mostLikedAuthor = function(res) {
      return res.author === 'Edsger W. Dijkstra' && res.likes === 17
    }
    const result = listHelper.mostLikes(listWithSixBlog)
    expect(mostLikedAuthor(result))
  })
